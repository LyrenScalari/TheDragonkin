...
import theDragonkin.orbs.DefaultOrb;
import theDragonkin.powers.JoltedPower;

import static theDragonkin.DefaultMod.makeCardPath;

public class Sagiate extends AbstractMagicGremoryCard implements BranchingUpgradesCard {
    public static final String ID = DefaultMod.makeID(Sagiate.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        if (this.hasTag(CustomTags.Wind)){
            addToBot(new ChannelAction(new DefaultOrb()));
        }
        else {
