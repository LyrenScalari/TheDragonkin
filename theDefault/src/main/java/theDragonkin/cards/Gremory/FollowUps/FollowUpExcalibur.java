...
@AutoAdd.Ignore
public class FollowUpExcalibur extends AbstractMagicGremoryCard {
    public static final String ID = DefaultMod.makeID(FollowUpExcalibur.class.getSimpleName());
