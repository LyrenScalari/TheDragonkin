...
@AutoAdd.Ignore
public class EverbloomPrimal extends AbstractGroveKeeperCard {
    public static final String ID = DragonkinMod.makeID(EverbloomPrimal.class.getSimpleName());
