...
public abstract class AbstractDeathspeakerCard extends AbstractDefaultCard {
    ...
    public boolean upgradedMagicDamage;
    public boolean isMagicDamageModified;
    public int MagicBlock;
    public int baseMagicBlock;
    public boolean upgradedMagicBlock;
    public boolean isMagicBlockModified;
    @Override
