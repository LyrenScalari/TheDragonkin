...
import theDragonkin.powers.Deathspeaker.JudgementPower;
import theDragonkin.powers.Deathspeaker.ManaPower;

import static theDragonkin.DragonkinMod.makeCardPath;

public class DeathApproaches extends AbstractDeathspeakerCard {
    public static final String ID = DragonkinMod.makeID(DeathApproaches.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        addToBot(new ApplyPowerAction(p,p,new JudgementPower(p,p,magicNumber)));
    }
