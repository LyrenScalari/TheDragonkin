...
public class SoulStrike extends AbstractDeathspeakerCard {
    public static final String ID = DragonkinMod.makeID(SoulStrike.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
