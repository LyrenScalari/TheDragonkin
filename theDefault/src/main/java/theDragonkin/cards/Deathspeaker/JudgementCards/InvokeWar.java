...
import theDragonkin.cards.Deathspeaker.DeathApproaches;
import theDragonkin.characters.TheDeathspeaker;
import theDragonkin.powers.Deathspeaker.ManaPower;

import static theDragonkin.DragonkinMod.makeCardPath;

public class InvokeWar extends AbstractDeathspeakerCard {
    public static final String ID = DragonkinMod.makeID(InvokeWar.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
