...
public class InvokePestilence extends AbstractDeathspeakerCard {
    public static final String ID = DragonkinMod.makeID(InvokePestilence.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        ...
        addToBot(new ApplyPowerAction(p,p,new SadisticPower(p,magicNumber)));
    }
