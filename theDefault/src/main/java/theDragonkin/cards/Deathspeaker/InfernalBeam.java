...
import theDragonkin.powers.Deathspeaker.InfernalWatch;

import static theDragonkin.DragonkinMod.*;

public class InfernalBeam extends AbstractSpellCard {
    public static final String ID = DragonkinMod.makeID(InfernalBeam.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public InfernalBeam(){
        ...
        MagicDamage = baseMagicDamage = DAMAGE;
    }
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
       addToBot(new DamageAction(m,new DamageInfo(p,MagicDamage), AbstractGameAction.AttackEffect.FIRE));
       addToBot(new ApplyPowerAction(m,p,new InfernalWatch(m,p,magicNumber)));
    }
