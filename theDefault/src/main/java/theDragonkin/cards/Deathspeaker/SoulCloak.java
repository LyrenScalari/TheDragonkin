...
public class SoulCloak extends AbstractDeathspeakerCard {
    public static final String ID = DragonkinMod.makeID(SoulCloak.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
