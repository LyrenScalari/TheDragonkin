...
import theDragonkin.cards.WindWalker.Skyfall;
...
@AutoAdd.Ignore
public class Tempest extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(Tempest.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        ...
        this.addToBot(new ChangeStanceAction(new theDragonkin.Stances.Tempest()));
    }
    // Upgraded stats.
    @Override
    public void upgrade() {
