...
@AutoAdd.Ignore
public class Whirlwind extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(Whirlwind.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        ...
        this.addToBot(new ChangeStanceAction(new theDragonkin.Stances.Whirlwind()));
    }
    // Upgraded stats.
    @Override
    public void upgrade() {
