...
@AutoAdd.Ignore
public class Conduit extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(Conduit.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        ...
        this.addToBot(new ChangeStanceAction(new theDragonkin.Stances.Conduit()));
    }
    // Upgraded stats.
    @Override
    public void upgrade() {
