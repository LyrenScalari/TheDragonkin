...
public class StaticBite extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(StaticBite.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
