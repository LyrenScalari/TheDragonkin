...
public class WindwalkerStrike extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(WindwalkerStrike.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
