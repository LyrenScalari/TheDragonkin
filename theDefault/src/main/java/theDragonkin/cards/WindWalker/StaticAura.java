...
public class StaticAura extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(StaticAura.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
