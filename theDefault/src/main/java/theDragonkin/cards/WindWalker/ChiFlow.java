...
public class ChiFlow extends AbstractWindWalkerCard {


    // TEXT DECLARATION

    public static final String ID = DragonkinMod.makeID(ChiFlow.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
