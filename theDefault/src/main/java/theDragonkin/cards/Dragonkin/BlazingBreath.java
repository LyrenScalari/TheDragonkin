...
// Skip this question until you start figuring out the AbstractDefaultCard/AbstractDragonkinCard and just extend DynamicCard
...
public class BlazingBreath extends CustomCard {
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(
                new MakeTempCardInDrawPileAction(new Burn(), 2,true,false));
