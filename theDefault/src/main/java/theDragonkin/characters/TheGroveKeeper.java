...
public class TheGroveKeeper extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_GROVEKEEPER;
        @SpireEnum(name = "GroveKeeper_Forest_Color") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor GroveKeeper_Forest_Color;
        @SpireEnum(name = "GroveKeeper_Forest_Color") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("GroveKeeper");
    ...
    public TheGroveKeeper(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(GrovekeeperStrike.ID);
        retVal.add(GrovekeeperStrike.ID);
    ...
    public AbstractCard.CardColor getCardColor() {
        return GroveKeeper_Forest_Color;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return GROVEKEEPER_FOREST;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheGroveKeeper(name, chosenClass);
    }
