...
import theDragonkin.cards.Flameweaver.FlameweaverDefend;
import theDragonkin.cards.Flameweaver.FlameweaverStrike;

import java.util.ArrayList;

import static theDragonkin.DragonkinMod.*;
import static theDragonkin.DragonkinMod.THE_DEFAULT_SKELETON_JSON;
import static theDragonkin.characters.TheFlameweaver.Enums.Flameweaver_Orange_Color;

public class TheFlameweaver extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_FLAMEWEAVER;
        @SpireEnum(name = "Flameweaver_Orange_Color") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor Flameweaver_Orange_Color;
        @SpireEnum(name = "Flameweaver_Orange_Color") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("TheFlameweaver");
    ...
    public TheFlameweaver(String name, PlayerClass setClass) {
    ...
    public ArrayList<String> getStartingDeck() {
        ...
        retVal.add(FlameweaverStrike.ID);
        retVal.add(FlameweaverStrike.ID);
        retVal.add(FlameweaverStrike.ID);
        retVal.add(FlameweaverStrike.ID);
        retVal.add(FlameweaverDefend.ID);
        retVal.add(FlameweaverDefend.ID);
        retVal.add(FlameweaverDefend.ID);
        retVal.add(FlameweaverDefend.ID);
    ...
    public AbstractCard.CardColor getCardColor() {
        return Flameweaver_Orange_Color;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return FLAMEWEAVER_ORANGE;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheFlameweaver(name, chosenClass);
    }

    // Should return a Color object to be used to color the miniature card images in run history.
    @Override
    public Color getCardRenderColor() {
        return DragonkinMod.FLAMEWEAVER_ORANGE;
    }
