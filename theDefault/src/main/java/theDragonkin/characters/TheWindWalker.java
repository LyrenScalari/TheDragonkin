...
public class TheWindWalker extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass TheWindWalker;
        @SpireEnum(name = "WindWalker_Jade_COLOR") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor WindWalker_Jade_COLOR;
        @SpireEnum(name = "WindWalker_Jade_COLOR") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("TheWindWalker");
    ...
    public TheWindWalker(String name, PlayerClass setClass) {
        super(name, setClass, new EnergyOrbDragonkin(),
                new SpineAnimation("theDragonkinResources/images/char/TheWindWalker/TheWindWalker.atlas","theDragonkinResources/images/char/TheWindWalker/TheWindWalker.json",0.5f));
        ...
        loadAnimation(
                Windwalker_SKELETON_ATLAS,
                Windwalker_SKELETON_JSON,
                1.0f);
    ...
    public AbstractCard.CardColor getCardColor() {
        return TheWindWalker.Enums.WindWalker_Jade_COLOR;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return DragonkinMod.WindWalker_Jade;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheWindWalker(name, chosenClass);
    }

    // Should return a Color object to be used to color the miniature card images in run history.
    @Override
    public Color getCardRenderColor() {
        return WindWalker_Jade;
    }
