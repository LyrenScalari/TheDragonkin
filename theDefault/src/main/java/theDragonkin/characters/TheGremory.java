...
public class TheGremory extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_GREMORY;
        @SpireEnum(name = "Gremory_Purple_Color") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor Gremory_Purple_Color;
        @SpireEnum(name = "Gremory_Purple_Color") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("Gremory");
    ...
    public TheGremory(String name, PlayerClass setClass) {
    ...
    public void doCharSelectScreenSelectEffect() {
        CardCrawlGame.sound.playA("ATTACK_MAGIC_SLOW_2", 1.25f); // Sound Effect
    ...
    public AbstractCard.CardColor getCardColor() {
        return Gremory_Purple_Color;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return theDragonkin.DefaultMod.GREMORY_PURPLE;
    }
    ...
    public AbstractPlayer newInstance() {
        return new TheGremory(name, chosenClass);
    }
