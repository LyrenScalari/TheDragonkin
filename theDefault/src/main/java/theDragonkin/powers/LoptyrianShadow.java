...
public class LoptyrianShadow extends AbstractPower implements modifyMagicPower {
    public static final String POWER_ID = DefaultMod.makeID("LoptyrianShadow");
    ...
    public LoptyrianShadow(AbstractCreature owner, int amount, boolean Temporary) {
        this.name = NAME;
        this.ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
