...
import theDragonkin.cards.Dragonkin.HauntingVoice;
...
public class InsanityPower extends AbstractPower {
    ...
    AbstractPower p = AbstractDungeon.player.getPower(InsanityPower.POWER_ID);
    public static final String POWER_ID = DefaultMod.makeID("Madness");
    ...
    public void atStartOfTurn(){
        addToBot(new MakeTempCardInHandAction(new HauntingVoice()));
    }
    @Override
