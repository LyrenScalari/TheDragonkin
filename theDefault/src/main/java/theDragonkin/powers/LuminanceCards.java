...
public class LuminanceCards extends TwoAmountPower implements modifyMagicPower {
    public static final String POWER_ID =  DefaultMod.makeID("LuminanceCards");
    ...
    public LuminanceCards(AbstractCreature owner, int amount, int cards) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
