...
public class ImmaculateSnow extends AbstractPower {
    public AbstractCreature source;

    public static final String POWER_ID = DefaultMod.makeID("ImmaculateSnow");
    ...
    public ImmaculateSnow(final AbstractCreature owner, final AbstractCreature source) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.source = source;
    ...
    public void onInitialApplication() {
        ...
        for (AbstractPower p : AbstractDungeon.player.powers) {
            ...
            if (p.ID.equals(ImmaculateSnow.POWER_ID) && p != this) {
                addToBot(new RemoveSpecificPowerAction(owner, owner, p));
            }
        }
    }
