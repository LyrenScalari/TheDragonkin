...
public class KindlingDuration extends TwoAmountPower implements modifyMagicPower, NonStackablePower {
    public static final String POWER_ID =  DefaultMod.makeID("KindlingDuration");
    ...
    public KindlingDuration(AbstractCreature owner, int amount, int duration) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
    ...
    public void updateDescription() {
        ...
        this.description += DESCRIPTIONS[5] + DESCRIPTIONS[6];
