...
public class DeepFrostDuration extends TwoAmountPower implements modifyMagicPower, NonStackablePower {
    public static final String POWER_ID =  DefaultMod.makeID("DeepFrostDuration");
    private static final PowerStrings powerStrings = CardCrawlGame.languagePack.getPowerStrings(POWER_ID);
    public static final String NAME = powerStrings.NAME;
    public static final String[] DESCRIPTIONS = powerStrings.DESCRIPTIONS;
    private static final Texture tex84 = TextureLoader.getTexture(makePowerPath("DeepFrost.png"));
    private static final Texture tex32 = TextureLoader.getTexture(makePowerPath("DeepFrost32.png"));

    public DeepFrostDuration(AbstractCreature owner, int amount, int duration) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
