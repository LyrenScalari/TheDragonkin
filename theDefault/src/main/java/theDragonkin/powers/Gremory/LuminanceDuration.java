...
public class LuminanceDuration extends TwoAmountPower implements modifyMagicPower, NonStackablePower {
    public static final String POWER_ID =  DefaultMod.makeID("LuminanceDuration");
    ...
    public LuminanceDuration(AbstractCreature owner, int amount, int duration) {
        name = NAME;
        ID = POWER_ID;
        this.owner = owner;
        this.amount = amount;
