...
public class RazorWind extends CustomOrb {
    public static final String ORB_ID = DragonkinMod.makeID("RazorWind");
    ...
    public RazorWind() {
        ...
        DamageModifierManager.addModifier(this, new theDragonkin.DamageModifiers.Wind());
    }
    @Override
    public void onEvoke(){
