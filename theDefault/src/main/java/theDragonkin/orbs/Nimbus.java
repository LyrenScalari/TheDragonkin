...
public class Nimbus extends CustomOrb {
    public static final String ORB_ID = DragonkinMod.makeID("Nimbus");
    ...
    public void onEvoke(){
        ...
        if (m != null) {
            ...
            AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(AbstractDungeon.player, evokeAmount, DamageInfo.DamageType.THORNS), AbstractGameAction.AttackEffect.NONE, true));
    ...
    public void updateDescription() { // Set the on-hover description of the orb
        ...
        description = DESCRIPTIONS[0] + passiveAmount + DESCRIPTIONS[1]+ passiveAmount + DESCRIPTIONS[2] + DESCRIPTIONS[3] + evokeAmount + DESCRIPTIONS[4] + evokeAmount + DESCRIPTIONS[5];
    }
    @Override
    ...
    public void onEndOfTurn() {// 1.At the start of your turn.
        ...
        if (m != null) {
            ...
            AbstractDungeon.actionManager.addToBottom(new VFXAction(new LightningEffect(m.drawX, m.drawY), speedTime));
            AbstractDungeon.actionManager.addToBottom(new SFXAction("ORB_LIGHTNING_EVOKE"));
            AbstractDungeon.actionManager.addToBottom(new DamageAction(m, new DamageInfo(AbstractDungeon.player,passiveAmount, DamageInfo.DamageType.THORNS), AbstractGameAction.AttackEffect.NONE, true));
