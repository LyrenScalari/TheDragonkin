...
import static theDragonknight.characters.TheDefault.Enums.Justicar_Red_COLOR;
...
public class DragonkinMod implements
    ...
    public void receiveEditCharacters() {
        ...
        BaseMod.addCharacter(new TheDefault("the Dragonknight", TheDragonknight.Enums.THE_DRAGONKNIGHT),
    ...
    public void receiveEditCards() {
       ...
       // BaseMod.addDynamicVariable(new HealDynVar());
        ...
        new AutoAdd("DragonknightMod").packageFilter(AbstractDragonkinCard.class).setDefaultSeen(true).cards();
