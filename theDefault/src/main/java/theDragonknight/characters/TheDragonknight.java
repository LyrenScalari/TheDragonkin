package theDragonknight.characters;
...
public class TheDragonknight extends CustomPlayer {
    ...
    public static class Enums {
        @SpireEnum
        public static AbstractPlayer.PlayerClass THE_DRAGONKNIGHT;
        @SpireEnum(name = "Dragonknight_Crimson_Color") // These two HAVE to have the same absolutely identical name.
        public static AbstractCard.CardColor Dragonknight_Crimson_Color;
        @SpireEnum(name = "Dragonknight_Crimson_Color") @SuppressWarnings("unused")
    ...
    private static final String ID = makeID("TheDragonknight");
    ...
    public AbstractCard.CardColor getCardColor() {
        return Dragonknight_Crimson_Color;
    }

    // Should return a color object to be used to color the trail of moving cards
    @Override
    public Color getCardTrailColor() {
        return DRAGONKNIGHT_CRIMSON;
    }
