...
public class NoxEternis extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(NoxEternis.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
