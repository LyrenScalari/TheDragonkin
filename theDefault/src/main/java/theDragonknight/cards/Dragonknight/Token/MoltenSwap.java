...
@AutoAdd.Ignore
public class MoltenSwap extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(MoltenSwap.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        if (AbstractDungeon.player.hasRelic(TaintedSoul.ID)) {
            TaintedSoul.type = new MagmaMark(AbstractDungeon.player);
        }
    }
