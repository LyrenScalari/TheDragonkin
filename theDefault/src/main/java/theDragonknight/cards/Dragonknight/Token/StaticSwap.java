...
@AutoAdd.Ignore
public class StaticSwap extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(StaticSwap.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        if (AbstractDungeon.player.hasRelic(TaintedSoul.ID)){
            TaintedSoul.type = new StormMark(AbstractDungeon.player);
        }
    }
