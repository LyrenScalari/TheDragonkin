...
@AutoAdd.Ignore
public class NoSwap extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(NoSwap.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
