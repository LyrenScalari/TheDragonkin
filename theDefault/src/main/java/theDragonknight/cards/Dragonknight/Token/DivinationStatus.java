...
public class DivinationStatus extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(DivinationStatus.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
