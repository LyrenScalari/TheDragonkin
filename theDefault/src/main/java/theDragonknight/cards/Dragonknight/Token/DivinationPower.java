...
public class DivinationPower extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(DivinationPower.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
