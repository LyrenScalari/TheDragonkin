...
@AutoAdd.Ignore
public class ToxicSwap extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(ToxicSwap.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
    ...
    public void onChoseThisOption() {
        if (AbstractDungeon.player.hasRelic(TaintedSoul.ID)) {
            TaintedSoul.type = new PlagueMark(AbstractDungeon.player);
        }
    }
