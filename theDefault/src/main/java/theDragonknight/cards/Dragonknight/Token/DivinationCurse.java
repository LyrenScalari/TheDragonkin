...
public class DivinationCurse extends AbstractDragonknightCard {

    public static final String ID = DragonknightMod.makeID(DivinationCurse.class.getSimpleName()); // USE THIS ONE FOR THE TEMPLATE;
