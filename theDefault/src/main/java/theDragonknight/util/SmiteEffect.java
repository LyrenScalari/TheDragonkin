...
public class SmiteEffect extends AbstractGameEffect {
    ...
    public SmiteEffect(AbstractCreature target, SmiteAction parentAction) {
        ...
        this.x = AbstractDungeon.player.hb.cX + MathUtils.random(-AbstractDungeon.player.hb.width / 2.0F - 80.0F * Settings.scale, AbstractDungeon.player.hb.width / 2.0F + 80.0F * Settings.scale);
